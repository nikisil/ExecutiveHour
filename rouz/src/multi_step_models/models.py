...
def compile_and_fit(
    model, window, patience=2, max_epochs=20, learning_rate=5e-3, save=False, fname="./tmp.keras"
):
...
class ConvolutionalMultiStep(keras.Model):
    ...
    def __init__(self, name, conv_width, output_width, nfeatures, *args, **kwargs):
        ...
        self.layers_.add(keras.layers.Conv1D(256, activation='relu', kernel_size=(conv_width)))
