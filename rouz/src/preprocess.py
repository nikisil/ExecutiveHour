...
date_range = pd.date_range(start='2020-01-01', end='2023-12-01') 
cal = calendar()
...
data_frame.add_previous_day_price_load_averages(day_ahead=True)
...
df.to_csv("data_set_final_with_average_DA_price.csv", float_format="%0.5f", index=False)